...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="Users_view.php" class="small-box-footer">Lebih Banyak <i class="fa fa-eye"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="books_view.php" class="small-box-footer">Lebih Banyak <i class="fa fa-eye"></i></a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            ...
            <a href="NewsPapers_view.php" class="small-box-footer">Lebih Banyak <i class="fa fa-eye"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Majalah Tersedia</p>
            </div>
            <div class="icon">
              <i class="fa  fa-sticky-note"></i>
            </div>
            <a href="Magazines_view.php" class="small-box-footer">Lebih Banyak <i class="fa fa-eye"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div><!--/first set-->
