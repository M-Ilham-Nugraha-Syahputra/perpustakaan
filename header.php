...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" style="text-decoration:none;" class="logo">
      ...
      <span class="logo-lg"><b>SDN 2 SUKOWONO</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($page=='members') { echo 'active';}?>"><a href="Users_view.php"><i class="fa fa-users"></i> <span>Member</span></a></li>
        <li class="<?php if($page=='books') { echo 'active';}?>"><a href="books_view.php"><i class="fa fa-book"></i> <span>Buku</span></a></li>
        <li class="<?php if($page=='newspaper') { echo 'active';}?>"><a href="NewsPapers_view.php"><i class="fa fa-newspaper-o"></i> <span>Koran</span></a></li>
        <li class="<?php if($page=='magazine') { echo 'active';}?>"><a href="Magazines_view.php"><i class="fa fa-sticky-note"></i> <span>Majalah</span></a></li>
        <li class="<?php if($page=='issue') { echo 'active';}?>"><a href="Book_Issue_view.php"><i class="fa fa-check"></i> <span>Daftar Masalah</span></a></li>
        <li class="<?php if($page=='return') { echo 'active';}?>"><a href="Return_Book_view.php"><i class="fa fa-reply"></i> <span>Daftar Pengembalian</span></a></li>
