<?php
	...
	// datalist.php
	$Translation['quick search'] = "Mencari Sesuatu?";
	...
	$Translation['comparison operator'] = "Bandingkan Operator";
	$Translation['comparison value'] = "Bandingkan nilai";
	$Translation['and'] = "dan";
	$Translation['or'] = "Ataur";
	$Translation['equal to'] = "Sama Dengan";
	$Translation['not equal to'] = "Tidak sama dengan";
	$Translation['greater than'] = "lebih besar dari";
	$Translation['greater than or equal to'] = "lebih besar atau sama dengan";
	$Translation['less than'] = "Kurang dari";
	$Translation['less than or equal to'] = "Kurang dari atau sama dengan";
	$Translation['like'] = "sama";
	$Translation['not like'] = "tidak sama";
	$Translation['is empty'] = "kosong";
	$Translation['is not empty'] = "tidak kosong";
	$Translation['apply filters'] = "terapkan filter";
	$Translation['save filters'] = "simpan dan terapkan filter";
	$Translation['saved filters title'] = "kode html untuk terapkan filter";
	...
	$Translation['clear filters'] = "hapus filter";
	$Translation['order by'] = 'urutkan dengan';
	$Translation['go to page'] = 'pergi ke laman:';
	$Translation['none'] = 'Non';
	$Translation['Select all records'] = 'pilih semua rekaman';
	$Translation['With selected records'] = 'dengan rekaman terpilih';
	$Translation['Print Preview Detail View'] = 'cetak detail tampilan';
	$Translation['Print Preview Table View'] = 'cetak tampilan tabel';
	$Translation['Print'] = 'Cetak';
	$Translation['Cancel Printing'] = 'Batal';
	$Translation['Cancel Selection'] = 'batalkan pilihan';
	$Translation['Maximum records allowed to enable this feature is'] = 'rekaman maksimal untuk mengaktifkan fitur ini';
	$Translation['No matches found!'] = 'tidak ditemukan kecocokan!';
	$Translation['Start typing to get suggestions'] = 'temukan rekomendasi.';

	// _dml.php
	$Translation['are you sure?'] = 'Apa anda yakin ingin menghapus ini?';
	$Translation['add new record'] = 'Tambah Rekaman Baru';
	$Translation['update record'] = 'Update Rekaman';
	$Translation['delete record'] = 'Hapus Rekaman';
	...
	$Translation['upload image'] = 'Unggah File Baru ';
	$Translation['select image'] = 'Pilih Gambar ';
	$Translation['remove image'] = 'Hapus File';
	$Translation['month names'] = 'Januari,Februari,Maret,April,Mei,Juni,Juli,Agustus,September,Oktober,November,Desember';
	$Translation['field not null'] = 'Anda tidak boleh mengosongi bagian ini.';
	$Translation['*'] = '*';
	$Translation['today'] = 'hari Ini';
	...
	$Translation['Save New'] = 'Simpan';
	$Translation['Save As Copy'] = 'Simpan salin ';
	$Translation['Deselect'] = 'batal';
	$Translation['Add New'] = 'Tambah Baru';
	$Translation['Delete'] = 'Hapus';
	$Translation['Cancel'] = 'Batal';
	$Translation['Print Preview'] = 'Cetak Hasil';
	$Translation['Save Changes'] = 'Simpan ';
	$Translation['CSV'] = 'Simpan Hasil';
	$Translation['Reset Filters'] = 'Tampilkan Semua';
	$Translation['Find It'] = 'Cari';
	$Translation['Previous'] = 'Sebelumnya';
	$Translation['Next'] = 'Selanjutnya';
	...
	// separateDVTV.php
	$Translation['please wait'] = "Mohon Tunggu";

	// _view.php
	$Translation['tableAccessDenied']="Maaf! Anda tidak memiliki izin untuk mengakses tabel ini. Harap hubungi administrasi untuk melaporkan masalah.";

	// incCommon.php
	$Translation['not signed in']="Anda belum masuk";
	$Translation['sign in']="Masuk";
	$Translation['signed as']="Masuk sebagai";
	$Translation['sign out']="Keluar";
	$Translation['admin setup needed']="Pengaturan admin belum di atur. Harap login sebagai <a href=admin/>admin control panel</a> untuk mengatur pengaturan.";
	$Translation['db setup needed']="Pengaturan program belum diatur. Harap login ke <a href=setup.php>setup page</a> terlebih dahulu.";
	$Translation['new record saved']="Perubahan telah berhasil di simpan.";
	$Translation['record updated']="Perubahan telah berhasil di simpan.";

	// index.php
	$Translation['admin area']="Admin Area";
	$Translation['login failed']="Login gagal tolong coba lagi.";
	$Translation['sign in here']="Sign In Here";
	$Translation['remember me']="Ingat username";
	$Translation['username']="Username";
	$Translation['password']="Password";
	$Translation['go to signup']="Tidak memiliki username? <br />&nbsp; <a href=membership_signup.php>Sign up here</a>";
	$Translation['forgot password']="lupa pssword anda? <a href=membership_passwordReset.php>klik disini</a>";
	$Translation['browse as guest']="<a href=index.php>Lanjutkan pencarian sebagai pengunjung</a>";
	$Translation['no table access']="Anda tidak memiliki akses yang cukup untuk menjelajahi halaman ini . Harap login terlebih dahulu.";
	$Translation['signup']="Sign up";

	// checkMemberID.php
	$Translation['user already exists']="Username '<MemberID>' Sudah digunakan. Coba username yang lain.";
	$Translation['user available']="Username '<MemberID>' tersedia dan bisa digunakan.";
	$Translation['empty user']="Tolong ketik di kolom username dan klik 'Chek ketersediaan'.";

	// membership_thankyou.php
	$Translation['thanks']="Terimakasih telah mendaftar!";
	$Translation['sign in no approval']="Jika anda telah memilih grup tanpa persetujuan admin, anda bisa login terlebih dahulu <a href=index.php?signIn=1>disini</a>.";
	$Translation['sign in wait approval']="jika anda telah memilih grup yang memerlukan persetujuan admin, Harap tunggu email untuk persetujuan anda.";

	// membership_signup.php
	$Translation['username empty']="Anda harus melengkapi kolong username. harap isi kolom username";
	$Translation['password invalid']="Anda harus mengisi pasword dengan 4 karakter atau lebih, Tanpa spasi. Harap mengisi password sesuai aturan";
